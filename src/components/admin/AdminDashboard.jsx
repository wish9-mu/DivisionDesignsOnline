...
/* ── Brand-aligned color palette (Purple to Peach Gradient) ─────────────────────────── */
const COLORS_STATUS = [
  "#8E1616",
  "#DB4CB2",
  "#1a6b3a",
    ...
    return (
      <text x={cx} y={cy} textAnchor="middle" dominantBaseline="central">
        <tspan
          x={cx}
          dy="-0.5em"
          style={{ fontSize: "1.4rem", fontWeight: 800, fill: "#1a1a2e" }}
        >
          {total}
        </tspan>
        <tspan
      ...
      <div className="admin__charts">
        ...
        <div className="admin__chart-card admin__chart-card--wide">
          <h3 className="admin__chart-title">
            <span
              className="admin__chart-dot"
              style={{ background: "#EB848C" }}
            />
            Revenue Over Time
          </h3>
          {revenueData.length > 0 ? (
              ...
              >
                <defs>
                  <linearGradient id="revGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#EB848C" stopOpacity={0.2} />
                    <stop offset="100%" stopColor="#EB848C" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <CartesianGrid
                  strokeDasharray="3 3"
            ...
            <div className="admin__chart-empty">
          ...
          {statusData.length > 0 ? (
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                ...
                <Tooltip />
                {renderCenterLabel(totalOrders)({ viewBox: { cx: 0, cy: 0 } })
                  ? null
                  : null}
              </PieChart>
            </ResponsiveContainer>
              ...
              >
                <defs>
                  <linearGradient id="aptGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#AF4BCE" stopOpacity={0.25} />
                    <stop offset="100%" stopColor="#AF4BCE" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <CartesianGrid
                  strokeDasharray="3 3"
